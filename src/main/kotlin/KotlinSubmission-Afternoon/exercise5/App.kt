...
fun main() {
     ...
     *
     */
    Rivana.setProfile("Rivana", 20, 170)
    ...
    **/
     ...
     * Fast and Serious -> jalan 5x, lari 4x, makan 4x, minum 4x, lompat 3x, duduk 2x
     */
    for (i in 1..5) Rivana.jalan()
    for (i in 1..4) Rivana.lari()
    for (i in 1..4) Rivana.makan()
    for (i in 1..4) Rivana.minum()
    for (i in 1..3) Rivana.lompat()
    for (i in 1..2) Rivana.duduk()
